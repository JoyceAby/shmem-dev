...
typedef struct shmemi_transport {
    // control plane
    int (*can_access_peer)(int *access, shmemi_transport_pe_info_t *peer,
                            struct shmemi_transport *t, shmemi_device_host_state_t *g_state);
...
extern shmemi_host_state_t g_host_state;
