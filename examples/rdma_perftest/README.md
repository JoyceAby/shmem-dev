...
mpirun -np 2 ./build/bin/rdma_perftest tcp://127.0.0.1:8765 2 0 0 highlevel_put_pingpong_latency 64
```

3.命令行参数说明
    mpirun -np 2 ./rdma_perftest <ipport> <g_npus> <f_rank> <f_npu> <test_type> <msg_len>
